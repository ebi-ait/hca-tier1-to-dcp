...
tier1_to_dcp = {
    ...
    # tissue_type
    'sampled_site_condition': 'specimen_from_organism.diseases.text', 
    # if is healthy PATO,
    #     if adjacent PATO & adjacent disease_ontology_term_id
    #     else disease_ontology_term_id
...
"""
Dictionary with fields that could potentially generate a meaninigful protocol name 
like i.e. 10x_3_v2_protocol, biopsy_protocol etc.
"""
protocol_ids = {
    'Collection protocol':
    {
        ...
        'dcp_fields': ['collection_protocol.method.text', 
    ...
    'Library preparation protocol':
    {
        ...
        'dcp_fields': ['library_preparation_protocol.library_construction_method.ontology', 
    ...
    'Sequencing protocol':
    {
        ...
        'dcp_fields': ['sequencing_protocol.instrument_manufacturer_model.ontology', 
    ...
    'Analysis protocol':
    {
        ...
        'dcp_fields': ['analysis_protocol.alignment_software_version', 
    ...
    'Enrichment protocol':
    {
        ...
        'dcp_fields': ['enrichment_protocol.markers', 
