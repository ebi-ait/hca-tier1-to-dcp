...
tier1_to_dcp = {
    ...
    'institute': 'cell_suspension.processing_institute',
    'sample_collection_site': 'specimen_from_organism.collection_institute.name',
...
KEY_COLS = ["library_id", "sample_id", "donor_id", "dataset_id"]